(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const n of document.querySelectorAll('link[rel="modulepreload"]'))a(n);new MutationObserver(n=>{for(const r of n)if(r.type==="childList")for(const i of r.addedNodes)i.tagName==="LINK"&&i.rel==="modulepreload"&&a(i)}).observe(document,{childList:!0,subtree:!0});function s(n){const r={};return n.integrity&&(r.integrity=n.integrity),n.referrerPolicy&&(r.referrerPolicy=n.referrerPolicy),n.crossOrigin==="use-credentials"?r.credentials="include":n.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function a(n){if(n.ep)return;n.ep=!0;const r=s(n);fetch(n.href,r)}})();var Lt;const ee=typeof window<"u"?(Lt=window.matchMedia)==null?void 0:Lt.call(window,"(prefers-reduced-motion: reduce)"):null,Se=new Set,Jt="cubic-bezier(.2,.75,.25,1)";var Nt;(Nt=ee==null?void 0:ee.addEventListener)==null||Nt.call(ee,"change",e=>{e.matches&&Se.forEach(t=>t.cancel())});function De(e,{duration:t=240,delay:s=0,distance:a=8,fromOpacity:n=0}={}){if(!(e!=null&&e.animate)||ee!=null&&ee.matches)return;const r=e.animate([{opacity:n,transform:`translateY(${a}px)`},{opacity:1,transform:"translateY(0)"}],{duration:t,delay:s,easing:Jt,fill:"backwards"});return r.id="workspace-reveal",Se.add(r),r.finished.then(()=>Se.delete(r),()=>Se.delete(r)),r}function Xt(e){if(ee!=null&&ee.matches)return;const t=e.querySelectorAll([".adm-head",".adm-tabs",".dashboard-kpis > .kpi",".dashboard-overview > section",".requests-card",".request-progress",".detail-main > .card",".detail-aside > .card",".form-page #prForm > .card",".insights-page > .kpis > .kpi",".insights-page > .card",".insights-page .adm-grid2 > .card",".vcard",".adm > .adm-card",".adm > .adm-banner"].join(","));let s=0;for(const a of[...t].slice(0,16)){const n=a.getBoundingClientRect();n.bottom<=0||n.top>=window.innerHeight||De(a,{delay:Math.min(s++*22,154),distance:10})}}const Mt={APP_URL:"https://script.google.com/macros/s/AKfycby5ZM_xx3GisD_5tBWM9USmVoqKf7nC-6zh7fVZAS6HuBT5gr-TtMOGJNqSmtTsNrc/exec",CLIENT_ID:"975636156405-6b56sp8duaqmjg54tnqqhahiioseokqn.apps.googleusercontent.com"},Ce="oizom-id-token";let ct=null;function ea(e){try{return JSON.parse(atob(e.split(".")[1])).exp*1e3}catch{return 0}}function Le(){const e=localStorage.getItem(Ce);return e?ea(e)<Date.now()+3e4?(localStorage.removeItem(Ce),null):e:null}function ta(){const e=Le();if(!e)return null;try{const t=e.split(".")[1].replace(/-/g,"+").replace(/_/g,"/"),s=JSON.parse(decodeURIComponent(escape(atob(t))));return{email:s.email||"",name:s.name||"",picture:s.picture||""}}catch{return null}}function aa(){localStorage.removeItem(Ce),window.google&&google.accounts&&google.accounts.id.disableAutoSelect(),location.reload()}function na(e){if(ct=e,Le()){e();return}Xe(()=>{google.accounts.id.initialize({client_id:Mt.CLIENT_ID,hd:"oizom.com",auto_select:!0,callback:t=>{localStorage.setItem(Ce,t.credential),ct()}}),google.accounts.id.prompt()})}function Xe(e,t=0){if(window.google&&google.accounts)return e();if(t>100){console.error("Google Identity Services failed to load");return}setTimeout(()=>Xe(e,t+1),100)}function sa(e){Xe(()=>{google.accounts.id.renderButton(e,{theme:"filled_blue",size:"large",width:280})})}class Ie extends Error{}async function H(e,t={}){const s=Le();if(!s)throw new Ie("SIGNED_OUT");const a=await fetch(Mt.APP_URL,{method:"POST",body:JSON.stringify({action:e,token:s,...t})});if(!a.ok)throw new Ie("HTTP "+a.status);const n=await a.json();if(!n.ok)throw new Ie(n.error||"Request failed");return n}function oa(e,t){const s=Number(e),a=Number(t);return e===""||e==null||t===""||t==null||!isFinite(s)||!isFinite(a)?"":Math.round(s*a*100)/100}function ra(e){let t=0,s=!1;for(const a of e){const n=Number(a.lineTotal);a.lineTotal!==""&&a.lineTotal!=null&&isFinite(n)&&(t+=n,s=!0)}return s?Math.round(t*100)/100:""}function ia(e){if(!e.length)return"";const t=e[0].description||"";return e.length>1?`${t} (+${e.length-1} more)`:t}function la(e){return e.length?e.length===1?[e[0].qty,e[0].unit].filter(Boolean).join(" "):e.length+" items":""}function mt(e,t){const s={};for(const a of t)(s[a.prId]=s[a.prId]||[]).push(a);for(const a in s)s[a].sort((n,r)=>Number(n.itemNo)-Number(r.itemNo));return e.map(a=>{const n=s[a.id]||[];return{...a,items:n,amount:a.totalAmount,item:ia(n),qty:la(n)}})}let I={prs:[],lists:{},vendors:[],projects:[],materialTypes:[],notifications:[],me:null,lastSync:null,err:"",loading:!1};const He=new Set;let ut=!1,me=null,Be=0;function Fe(){He.forEach(e=>e(I))}const M={get:()=>I,subscribe(e){return He.add(e),()=>He.delete(e)},refresh(){return me||(I={...I,loading:!0},me=Promise.resolve().then(async()=>{try{let e,t;do t=Be,e=await H("list");while(t!==Be);ut=!0,I={prs:mt(e.prs,e.items||[]),lists:e.lists||{},vendors:e.vendors||[],projects:e.projects||[],materialTypes:e.materialTypes||[],notifications:e.notifications||[],me:e.me,lastSync:new Date,err:"",loading:!1}}catch(e){if(e.message==="SIGNED_OUT"&&ut){location.reload();return}I={...I,err:e.message,loading:!1}}}).finally(()=>{me=null,I={...I,loading:!1},Fe()}),Fe(),me)},async applyResult(e,{itemsChanged:t=!1}={}){Be++;const s={err:""};let a=!1;if(e.pr&&e.pr.id){const n=I.prs.find(r=>r.id===e.pr.id);if(!Array.isArray(e.items)&&(t||!n))return M.refresh();if(!n||!(Date.parse(n.updatedAt)>Date.parse(e.pr.updatedAt))){const r=(e.items||(n==null?void 0:n.items)||[]).map(c=>({...c,prId:e.pr.id})),i=mt([e.pr],r)[0];s.prs=n?I.prs.map(c=>c.id===i.id?i:c):[...I.prs,i]}a=!0}e.deleted&&(s.prs=I.prs.filter(n=>n.id!==e.deleted),a=!0);for(const n of["vendors","projects","materialTypes","notifications"])Array.isArray(e[n])&&(s[n]=e[n],a=!0);if(Array.isArray(e.users)){const n=I.me&&e.users.find(r=>r.email.toLowerCase()===I.me.email.toLowerCase());if(I.me&&(!n||!n.role))return M.refresh();n&&(s.me={...I.me,role:n.role,department:n.department}),a=!0}if(!a)return M.refresh();I={...I,...s},Fe()}},pt={trash:'<path d="M3 6h18M9 6V3h6v3M5 6l1 15h12l1-15M10 10v7M14 10v7"/>',users:'<circle cx="9" cy="7" r="3"/><path d="M3 21v-3a6 6 0 0 1 12 0v3M16 4a3 3 0 0 1 0 6M17 14a5 5 0 0 1 4 5v2"/>',grid:'<rect x="3" y="3" width="7" height="7" rx="1.5"/><rect x="14" y="3" width="7" height="7" rx="1.5"/><rect x="3" y="14" width="7" height="7" rx="1.5"/><rect x="14" y="14" width="7" height="7" rx="1.5"/>',vendors:'<path d="M3 10h18M5 10v11h14V10M3 10l2-7h14l2 7M9 21v-7h6v7"/>',chart:'<path d="M4 3v17h17M8 15l4-5 4 2 5-7"/>',settings:'<path d="M4 7h16M4 17h16"/><circle cx="9" cy="7" r="3" fill="currentColor" stroke="none"/><circle cx="15" cy="17" r="3" fill="currentColor" stroke="none"/>',plus:'<path d="M12 5v14M5 12h14"/>',refresh:'<path d="M20 7v5h-5M4 17v-5h5M6 7a7 7 0 0 1 12-1l2 3M4 15l2 3a7 7 0 0 0 12-1"/>',bell:'<path d="M18 8a6 6 0 0 0-12 0c0 7-3 7-3 9h18c0-2-3-2-3-9M10 21h4"/>',down:'<path d="m6 9 6 6 6-6"/>',right:'<path d="m9 5 7 7-7 7"/>',left:'<path d="m15 5-7 7 7 7"/>',arrow:'<path d="M4 12h16m-6-6 6 6-6 6"/>',search:'<circle cx="10.5" cy="10.5" r="6.5"/><path d="m16 16 5 5"/>',filter:'<path d="M4 7h16M7 12h10M10 17h4"/>',file:'<path d="M14 3H5v18h14V8zM14 3v5h5M8 12h8M8 16h5"/>',clock:'<circle cx="12" cy="12" r="9"/><path d="M12 7v5l3 2"/>',wallet:'<path d="M20 8V5H5a2 2 0 0 0 0 4h16v11H5a2 2 0 0 1-2-2V7M21 12h-5v5h5"/>',truck:'<path d="M3 5h11v12H3zM14 9h4l3 4v4h-7"/><circle cx="7" cy="18" r="2"/><circle cx="18" cy="18" r="2"/>',check:'<path d="m5 12 4 4L19 6"/>',package:'<path d="m12 3 9 5v9l-9 5-9-5V8zM3 8l9 5 9-5M12 13v9M8 5l9 5"/>',more:'<circle cx="5" cy="12" r="1"/><circle cx="12" cy="12" r="1"/><circle cx="19" cy="12" r="1"/>',edit:'<path d="m15 4 5 5M4 20l5-1L21 7l-5-5L4 14z"/>',close:'<path d="m6 6 12 12M6 18 18 6"/>',menu:'<path d="M4 6h16M4 12h16M4 18h16"/>',logout:'<path d="M9 4H4v16h5M10 12h11m-5-5 5 5-5 5"/>',shield:'<path d="m12 3 8 3v6c0 5-8 9-8 9s-8-4-8-9V6zM8 12l3 3 5-6"/>',pause:'<path d="M8 5v14M16 5v14"/>',info:'<circle cx="12" cy="12" r="9"/><path d="M12 11v6M12 7v.01"/>'};function v(e,t=""){return`<svg class="ico ${t}" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true">${pt[e]||pt.file}</svg>`}const o=e=>e==null?"":String(e).replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t]);function Ne(e){return`<span class="chip ${o(e)}" data-s="${o(e)}">${o(e)}</span>`}function q(e,t=!1){document.querySelectorAll(".toast").forEach(a=>a.remove());const s=document.createElement("div");s.setAttribute("role",t?"alert":"status"),s.setAttribute("aria-live",t?"assertive":"polite"),s.className="toast"+(t?" err":""),s.innerHTML=`
    <span class="t-ico">${v(t?"info":"check")}</span>
    <div class="t-body">
      <div class="t-title">${t?"Error":"Success"}</div>
      <div class="t-msg"></div>
    </div>
    <button class="t-close" aria-label="Dismiss">&times;</button>`,s.querySelector(".t-msg").textContent=e,s.querySelector(".t-close").onclick=()=>s.remove(),document.body.appendChild(s),setTimeout(()=>s.remove(),t?6e3:4e3)}const X=e=>e?o(String(e).slice(0,10)):"—";function Me(e){return String(e||"").split("@")[0].split(/[._-]+/).filter(Boolean).map(s=>s[0].toUpperCase()+s.slice(1)).join(" ")||e}function et(e){const t=String(e||"").split("@")[0].split(/[._-]+/).filter(Boolean);return((t[0]||"u")[0]+(t[1]?t[1][0]:"")).toUpperCase()}const vt={INR:"₹",USD:"$",GBP:"£",EUR:"€",JPY:"¥",CNY:"¥",AED:"د.إ ",SGD:"S$",AUD:"A$",CAD:"C$",CHF:"CHF ",Unknown:""},we=e=>vt[e]!=null?vt[e]:e+" ";function ye(e,t){const s=e==="INR"?"en-IN":"en-US";return we(e)+Number(t).toLocaleString(s,{maximumFractionDigits:2})}function Z(e,t){return e==="INR"?t>=1e7?"₹"+(t/1e7).toFixed(2)+" Cr":t>=1e5?"₹"+(t/1e5).toFixed(1)+"L":"₹"+Math.round(t).toLocaleString("en-IN"):t>=1e6?we(e)+(t/1e6).toFixed(2)+"M":t>=1e3?we(e)+(t/1e3).toFixed(1)+"K":we(e)+Math.round(t).toLocaleString("en-US")}const be=["Cancelled","Rejected"],da=["Ordered","In Transit","Received"],Ee=e=>da.includes(e.status)&&e.paymentStatus!=="Paid";function ht(e){const t={};for(const s of e){const a=Number(s.amount);if(!s.amount||!isFinite(a))continue;const n=s.currency||"Unknown";t[n]=(t[n]||0)+a}return Object.entries(t).sort((s,a)=>a[1]-s[1])}function ca(e){const t=e.filter(n=>!be.includes(n.status)),s=e.filter(Ee),a=e.filter(n=>n.status==="Received").length;return{total:e.length,pending:e.filter(n=>n.status==="Submitted").length,unpaidCount:s.length,unpaidTotals:ht(s),inTransit:e.filter(n=>n.status==="In Transit").length,received:a,receivedPct:Math.round(a/(e.length||1)*100),spendTotals:ht(t)}}const Ve={total:()=>!0,pending:e=>e.status==="Submitted",unpaid:Ee,transit:e=>e.status==="In Transit",received:e=>e.status==="Received",spend:e=>!be.includes(e.status)};function ma(e,t){const s=String(t||"").toLowerCase();return e.filter(a=>String(a.requesterEmail||"").toLowerCase()===s)}function yt(e,t){const s=String(t||"").toLowerCase();return e.filter(a=>String(a.approverEmail||"").toLowerCase()===s&&s&&a.status!=="Rejected")}function Et(e,t){const s=String(t||"").toLowerCase();return e.filter(a=>String(a.department||"").toLowerCase()===s)}function ua(e){return e.filter(Ee)}function pa(e){const t={};for(const s of e){const a=String(s.approverEmail||"").toLowerCase();!a||s.status==="Rejected"||(t[a]=(t[a]||0)+1)}return Object.entries(t).map(([s,a])=>({email:s,count:a})).sort((s,a)=>a.count-s.count||s.email.localeCompare(a.email))}function xt(e){return[...new Set(e.filter(t=>t.amount&&isFinite(Number(t.amount))).map(t=>t.currency||"Unknown"))].sort()}function Ke(e,t,s){const a={};for(const n of e){const r=String(n.createdAt||"").slice(0,7);if(!/^\d{4}-\d{2}$/.test(r))continue;let i;if(t==="count")i=1;else{if(be.includes(n.status)||t==="unpaid"&&n.paymentStatus!=="Unpaid")continue;const c=Number(n.amount);if(!n.amount||!isFinite(c)||(n.currency||"Unknown")!==s)continue;i=c}a[r]=(a[r]||0)+i}return Object.keys(a).sort().map(n=>({month:n,value:a[n]}))}function va(e,t){const s={};for(const a of e){if(be.includes(a.status)||(a.currency||"Unknown")!==t)continue;const n=Number(a.amount);if(!a.amount||!isFinite(n))continue;const r=a.department||"Unassigned";s[r]=(s[r]||0)+n}return Object.entries(s).map(([a,n])=>({department:a,total:n})).sort((a,n)=>n.total-a.total)}function ha(e,t,s=6){const a={};for(const i of e){if(be.includes(i.status)||(i.currency||"Unknown")!==t)continue;const c=Number(i.amount);if(!i.amount||!isFinite(c))continue;const b=i.vendor||"Unspecified";a[b]=(a[b]||0)+c}const n=Object.entries(a).map(([i,c])=>({vendor:i,total:c})).sort((i,c)=>c.total-i.total);if(n.length<=s)return n;const r=n.slice(s).reduce((i,c)=>i+c.total,0);return[...n.slice(0,s),{vendor:"Other",total:r}]}function ya(e){const t={};for(const s of e)t[s.status]=(t[s.status]||0)+1;return t}function fa(e){const t=(r,i)=>{const c=Date.parse(r),b=Date.parse(i);return isFinite(c)&&isFinite(b)?(b-c)/864e5:null},s=r=>r.length?r.reduce((i,c)=>i+c,0)/r.length:null,a=e.map(r=>r.createdAt&&r.approvedAt?t(r.createdAt,r.approvedAt):null).filter(r=>r!=null&&r>=0),n=e.map(r=>r.poDate&&r.receivedAt?t(r.poDate,r.receivedAt):null).filter(r=>r!=null&&r>=0);return{avgApprovalDays:s(a),approvalSamples:a.length,avgDeliveryDays:s(n),deliverySamples:n.length}}const ba=[{key:"0-7",label:"0–7 days",min:0,max:7},{key:"8-14",label:"8–14 days",min:8,max:14},{key:"15-30",label:"15–30 days",min:15,max:30},{key:"30+",label:"30+ days",min:31,max:1/0}];function ga(e,t=Date.now()){const s=ba.map(a=>({...a,count:0}));return e.filter(Ee).forEach(a=>{const n=Date.parse(a.poDate||a.updatedAt||a.createdAt);if(!isFinite(n))return;const r=(t-n)/864e5;(s.find(i=>r>=i.min&&r<=i.max)||s[s.length-1]).count++}),s}const ze=["Submitted","Approved","Rejected","Ordered","In Transit","Received","Cancelled","On Hold"],It=["Unpaid","Paid","Partially Paid","FOC / Free"],Te={Submitted:{Approved:["admin","approver:dept"],Rejected:["admin","approver:dept"],Cancelled:["admin","requester:own"],"On Hold":["admin"]},Approved:{Ordered:["admin"],Cancelled:["admin"],"On Hold":["admin"],Rejected:["admin"],Submitted:["admin"]},Ordered:{"In Transit":["admin"],Received:["admin"],Cancelled:["admin"],"On Hold":["admin"]},"In Transit":{Received:["admin"],"On Hold":["admin"]},"On Hold":{Submitted:["admin"],Approved:["admin"],Ordered:["admin"],Cancelled:["admin"]},Rejected:{Submitted:["admin","requester:own"],Approved:["admin"]},Received:{},Cancelled:{}};function $a(e,t,s,a,n){const r=(Te[e]||{})[t];return r?r.some(i=>i==="requester:own"?s==="requester"&&a:i==="approver:dept"?s==="approver"&&n:i===s):!1}function Sa(e,t,s,a){return Object.keys(Te[e]||{}).filter(n=>$a(e,n,t,s,a))}function wa(e,t){return!!(Te[e]&&Te[e][t])}function ge(e,{valueFmt:t=String,colorOf:s}={}){if(!e.length)return'<div class="chart-empty">Not enough data yet.</div>';const a=Math.max(...e.map(n=>n.value),1);return`<div class="barlist">${e.map(n=>{const r=Math.max(n.value/a*100,n.value>0?2:0),i=s?s(n):"var(--brand)",c=`${n.label}: ${t(n.value)}${n.sub?" · "+n.sub:""}`;return`<div class="barrow" title="${o(c)}">
    ...
    ${D}
    ${L}
  </svg>`}const ka=["Submitted","Approved","Rejected"],u={sel:"total",tab:"mine",page:1,moreFilters:!1,currency:"",filters:{q:"",dept:"",vendor:"",status:"",from:"",to:""}},ue=25,Ra={total:"file",pending:"clock",unpaid:"wallet",transit:"truck",received:"package",spend:"chart"};let _e;function ne(e,t,s=!0){const a=document.activeElement,n=a&&e.contains(a)&&a.id?{id:a.id,start:a.selectionStart,end:a.selectionEnd}:null;if(Bt(e,t),s&&De(e.querySelector(".request-table tbody"),{duration:160,distance:3,fromOpacity:.5}),!n)return;const r=e.querySelector("#"+n.id);if(r&&(r.focus(),n.start!=null&&typeof r.setSelectionRange=="function"))try{r.setSelectionRange(n.start,n.end)}catch{}}const ft=e=>String(e||"").slice(0,10);function Ca(e){const t=u.filters;return!(t.dept&&e.department!==t.dept||t.vendor&&e.vendor!==t.vendor||t.status&&e.status!==t.status||t.from&&ft(e.createdAt)<t.from||t.to&&ft(e.createdAt)>t.to||t.q&&!`${e.id} ${e.item} ${e.vendor} ${e.department}`.toLowerCase().includes(t.q.trim().toLowerCase()))}function Bt(e,t){clearTimeout(_e),e.innerHTML=`
...
<p>A clear view of your purchases, from request to delivery.</p>
      ...
      <div id="tabBody"></div>
    </div>`,Ta(e.querySelector("#tabBody"),e,t)}const de=e=>e.length?e.map(([t,s])=>Z(t,s)).join(" + "):"—";function Ta(e,t,s){const a=s.me||{role:"",email:"",department:""},n=a.role==="approver",r=a.role==="admin",i=a.role==="finance",c=n?["mine","dept","approved"]:r?["mine","all"]:i?["mine","payments"]:["mine"];c.includes(u.tab)||(u.tab="mine");const b=u.tab==="dept",m=u.tab==="approved",g=u.tab==="all",R=u.tab==="payments",P=ma(s.prs,a.email),O=n?yt(s.prs,a.email):[],T=n?Et(s.prs,a.department):[],L=i?ua(s.prs):[],D=b?T:m?O:g?s.prs:R?L:P,p=ca(D),w=R?[{key:"total",n:p.total,l:"Awaiting payment",s:de(p.unpaidTotals)},{key:"transit",n:p.inTransit,l:"In transit",s:"trackable shipments",cls:"warn"},{key:"received",n:p.receivedPct+"%",l:"Received",s:p.received+" of "+p.total,cls:"go"},{key:"spend",n:p.spendTotals.length?Z(...p.spendTotals[0]):"—",l:"Total value",s:p.spendTotals.length>1?"+ "+de(p.spendTotals.slice(1)):""}]:b?[{key:"total",n:p.total,l:"Department PRs",s:a.department?"in "+a.department:""},{key:"pending",n:p.pending,l:"Pending approval",s:"awaiting decision",cls:"warn"},{key:"unpaid",n:p.unpaidCount,l:"Unpaid",s:de(p.unpaidTotals),cls:"bad"},{key:"transit",n:p.inTransit,l:"In transit",s:"trackable shipments",cls:"warn"},{key:"received",n:p.receivedPct+"%",l:"Received",s:p.received+" of "+p.total,cls:"go"},{key:"spend",n:p.spendTotals.length?Z(...p.spendTotals[0]):"—",l:"Total spend",s:p.spendTotals.length>1?"+ "+de(p.spendTotals.slice(1)):""}]:[{key:"total",n:p.total,l:m?"Approved PRs":g?"All PRs":"Total PRs",s:m?"across all requesters":g?"every department":""},...m?[]:[{key:"pending",n:p.pending,l:"Pending approval",s:"awaiting approver",cls:"warn"}],{key:"unpaid",n:p.unpaidCount,l:"Unpaid",s:de(p.unpaidTotals),cls:"bad"},{key:"transit",n:p.inTransit,l:"In transit",s:"trackable shipments",cls:"warn"},{key:"received",n:p.receivedPct+"%",l:"Received",s:p.received+" of "+p.total,cls:"go"},{key:"spend",n:p.spendTotals.length?Z(...p.spendTotals[0]):"—",l:m?"Approved spend":"Total spend",s:p.spendTotals.length>1?"+ "+de(p.spendTotals.slice(1)):""}];if(g)for(const l of pa(s.prs))w.push({key:"ap:"+l.email,n:l.count,l:"Approved by "+Me(l.email),s:l.email,cls:"go"});w.some(l=>l.key===u.sel)||(u.sel="total");const x=(u.sel.startsWith("ap:")?yt(s.prs,u.sel.slice(3)):D.filter(Ve[u.sel])).sort((l,k)=>(k.createdAt||"").localeCompare(l.createdAt||"")),$=w.find(l=>l.key===u.sel),B=[...new Set(D.map(l=>l.department).filter(Boolean))].sort(),y=[...new Set(D.map(l=>l.vendor).filter(Boolean))].sort();u.filters.dept&&!B.includes(u.filters.dept)&&(u.filters.dept=""),u.filters.vendor&&!y.includes(u.filters.vendor)&&(u.filters.vendor="");const f=x.filter(Ca),h=Object.values(u.filters).some(Boolean),A=Math.max(1,Math.ceil(f.length/ue));u.page=Math.min(Math.max(1,u.page),A);const C=f.slice((u.page-1)*ue,u.page*ue),E=xt(D);E.includes(u.currency)||(u.currency=E[0]||"");const j=u.currency?Ke(D,"spend",u.currency):[],_=["dept","vendor","from","to"].filter(l=>u.filters[l]).length,d=g?"All requests":b?"Department requests":m?"Approved by you":R?"Payment queue":"Your requests",S=l=>String(l.department||"").toLowerCase()===String(a.department||"").toLowerCase(),N=l=>{const k=r?ze:n&&l.status==="Submitted"&&S(l)?ka:null;return k?`<select class="status-sel" data-status="${o(l.status)}" aria-label="Status for ${o(l.id)}" data-id="${o(l.id)}">${k.map(F=>`<option ${F===l.status?"selected":""}>${o(F)}</option>`).join("")}</select>`:Ne(l.status)},U=l=>`<select class="pay-sel" aria-label="Payment status for ${o(l.id)}" data-id="${o(l.id)}">${It.map(k=>`<option ${k===l.paymentStatus?"selected":""}>${o(k)}</option>`).join("")}</select>`;e.innerHTML=`
    ...
    <div class="kpis dashboard-kpis" aria-label="Filter requests by summary">${w.filter(l=>!l.key.startsWith("ap:")).map(l=>`
      <button type="button" class="kpi clickable ${l.cls||""} ${l.key===u.sel?"sel":""}" data-key="${o(l.key)}" aria-pressed="${l.key===u.sel}">
        <span class="kpi-top"><span class="l">${o(l.l)}</span>${v(Ra[l.key])}</span>
    ...
    </section>`,e.querySelectorAll(".adm-tab").forEach(l=>l.onclick=()=>{u.tab=l.dataset.tab,u.sel="total",u.page=1,ne(t,s)}),e.querySelectorAll(".kpi.clickable").forEach(l=>l.onclick=()=>{u.sel=l.dataset.key,u.page=1,ne(t,s)}),e.querySelectorAll("tr.rowlink").forEach(l=>l.onclick=k=>{k.target.closest("a, select, button")||(location.hash="#/pr/"+l.dataset.id)}),e.querySelectorAll("[data-focus]").forEach(l=>l.onclick=()=>{var k,F,K;u.sel=l.dataset.focus,u.page=1,w.some(z=>z.key===u.sel)||(u.sel="total"),u.filters={q:"",dept:"",vendor:"",status:l.dataset.focus==="pending"?"Submitted":"",from:"",to:""},ne(t,s),(K=(F=t.querySelector(".requests-card")).scrollIntoView)==null||K.call(F,{behavior:(k=window.matchMedia)!=null&&k.call(window,"(prefers-reduced-motion: reduce)").matches?"instant":"smooth",block:"start"})}),e.querySelector("#dashMoreFilters").onclick=()=>{u.moreFilters=!u.moreFilters,e.querySelector("#advancedFilters").hidden=!u.moreFilters,e.querySelector("#dashMoreFilters").setAttribute("aria-expanded",String(u.moreFilters))};const Y=e.querySelector("#dashCurrency");Y&&(Y.onchange=()=>{u.currency=Y.value,ne(t,s)});const V=e.querySelector("#dashApprover");V&&(V.onchange=()=>{u.sel=V.value,u.page=1,ne(t,s)});const Q=l=>{var k,F;u.page+=l,ne(t,s),(F=(k=t.querySelector(".requests-card")).scrollIntoView)==null||F.call(k,{block:"start"})};e.querySelector("#dashPrev").onclick=()=>Q(-1),e.querySelector("#dashNext").onclick=()=>Q(1);const te=(l,k)=>{u.filters[l]=k,u.page=1,ne(t,s)};e.querySelector("#dashQ").oninput=l=>{u.filters.q=l.target.value,u.page=1,clearTimeout(_e),_e=setTimeout(()=>{t.isConnected&&ne(t,s,!1)},150)},e.querySelector("#dashDept").onchange=l=>te("dept",l.target.value),e.querySelector("#dashVendor").onchange=l=>te("vendor",l.target.value),e.querySelector("#dashStatus").onchange=l=>te("status",l.target.value),e.querySelector("#dashFrom").onchange=l=>te("from",l.target.value),e.querySelector("#dashTo").onchange=l=>te("to",l.target.value);const it=()=>{u.filters={q:"",dept:"",vendor:"",status:"",from:"",to:""},u.page=1,u.sel="total",ne(t,s)},lt=e.querySelector("#dashFilterClear"),dt=e.querySelector("#emptyClear");lt&&(lt.onclick=it),dt&&(dt.onclick=it),e.querySelectorAll(".status-sel").forEach(l=>{l.onclick=k=>k.stopPropagation(),l.onchange=async()=>{const k=l.dataset.id,F=s.prs.find(z=>z.id===k),K=l.value;if(!(!F||K===F.status)){if((K==="Rejected"||K==="Cancelled")&&!confirm(`Mark ${k} as ${K}?`)){l.value=F.status;return}l.disabled=!0;try{let z;a.role==="admin"&&!wa(F.status,K)?z=await H("update",{id:k,updates:{status:K}}):z=await H("transition",{id:k,to:K}),q(`${k} → ${K}`),await M.applyResult(z)}catch(z){q(z.message,!0),l.value=F.status,l.disabled=!1}}}}),e.querySelectorAll(".pay-sel").forEach(l=>{l.onclick=k=>k.stopPropagation(),l.onchange=async()=>{const k=l.dataset.id,F=s.prs.find(z=>z.id===k),K=l.value;if(!(!F||K===F.paymentStatus)){l.disabled=!0;try{const z=await H("update",{id:k,updates:{paymentStatus:K}});q(`${k} payment → ${K}`),await M.applyResult(z)}catch(z){q(z.message,!0),l.value=F.paymentStatus,l.disabled=!1}}}})}function tt(e,t){const s=String(t||"").toLowerCase();return e.filter(a=>String(a.vendor||"").toLowerCase()===s)}function at(e,t){const s=tt(e,t),a=s.filter(Ve.spend),n={};for(const r of a){const i=Number(r.amount);if(!r.amount||!isFinite(i))continue;const c=r.currency||"INR";n[c]=(n[c]||0)+i}return{count:s.length,spendTotals:Object.entries(n).sort((r,i)=>i[1]-r[1]),unpaid:s.filter(Ve.unpaid).length,lastOrder:s.reduce((r,i)=>{const c=String(i.createdAt||"");return/^\d{4}-\d{2}-\d{2}/.test(c)&&c>r?c:r},"")}}function Ft(e,t){if(e.type==="Domestic")return"Domestic";if(e.type==="International")return"Foreign";const s=new Set(tt(t,e.name).filter(r=>r.amount&&isFinite(Number(r.amount))).map(r=>r.currency||"INR"));if(!s.size)return"";const a=s.has("INR"),n=[...s].some(r=>r!=="INR");return a&&n?"Mixed":n?"Foreign":"Domestic"}const Aa=[{key:"name",weight:3},{key:"displayName",weight:3},{key:"category",weight:2},{key:"type",weight:2},{key:"departments",weight:2},{key:"contactPerson",weight:1},{key:"address",weight:1},{key:"paymentTerms",weight:1},{key:"notes",weight:1}],Pa={sensor:["pm","gas","module","electrochemical","particulate"],sensors:["pm","gas","module","electrochemical","particulate"],fab:["fabrication","enclosure","sheet metal","machining"],fabrication:["enclosure","sheet metal","machining"],enclosure:["fabrication","sheet metal","machining"],calibration:["nabl","certification","testing"],certification:["nabl","calibration","testing"],electronics:["components","distributor","semiconductor"],components:["electronics","distributor","semiconductor"],local:["india","domestic"],domestic:["india","local"],foreign:["international","import"],import:["international","foreign"]},qa=1,Da=.7,Ot=.5,La=.4,Na=.3,Ma=4,Ea=e=>e.length>=7?2:e.length>=Ma?1:0,Ae=e=>String(e??"").toLowerCase().trim();function xa(e,t){const s=e[t];return Ae(Array.isArray(s)?s.join(" "):s)}function jt(e){return Ae(e).split(/[\s,]+/).filter(Boolean)}function Ia(e,t){if(e===t)return 0;if(Math.abs(e.length-t.length)>2)return 99;let s=Array.from({length:t.length+1},(a,n)=>n);for(let a=1;a<=e.length;a++){const n=[a];for(let r=1;r<=t.length;r++)n[r]=Math.min(s[r]+1,n[r-1]+1,s[r-1]+(e[a-1]===t[r-1]?0:1));s=n}return s[t.length]}function bt(e,t){if(!e||!t)return 0;const s=e.split(/[^a-z0-9]+/).filter(Boolean);if(s.includes(t))return qa;if(s.some(n=>n.startsWith(t)))return Da;if(e.includes(t))return Ot;const a=Ea(t);return a&&s.some(n=>Ia(n,t)<=a)?Na:0}function Ba(e,t){const s=bt(e,t);if(s)return s;const a=Pa[t];return a&&a.some(r=>r.includes(" ")?e.includes(r):bt(e,r)>=Ot)?La:0}function Fa(e,t){const s=Array.isArray(t)?t:jt(t);if(!s.length)return 0;let a=0;for(const n of s){let r=0;for(const{key:i,weight:c}of Aa)r=Math.max(r,Ba(xa(e,i),n)*c);if(!r)return 0;a+=r}return a}function Ut(e,t){const s=jt(t);return s.length?(e||[]).map(a=>({v:a,score:Fa(a,s)})).filter(a=>a.score>0).sort((a,n)=>n.score-a.score||Ae(a.v.displayName||a.v.name).localeCompare(Ae(n.v.displayName||n.v.name))).map(a=>a.v):[...e||[]]}function xe(e,t,s="admSearch"){return`
    ...
    </div>`}const nt=(...e)=>o(e.filter(Boolean).join(" ").toLowerCase());function st(e,t){return`<tr class="adm-nomatch" hidden><td colspan="${e}" style="color:var(--adm-on-var)">${o(t)}</td></tr>`}function ot(e,{get:t,set:s,count:a,id:n="admSearch",match:r=null}){const i=e.querySelector("#"+n);if(!i)return;const c=i.closest(".adm-card"),b=c.querySelector(".admSearchClear"),m=()=>Oa(c,t(),a,r);i.oninput=()=>{s(i.value),b.hidden=!i.value,m()},i.onkeydown=g=>{g.key==="Escape"&&i.value&&(i.value="",i.oninput())},b.onclick=()=>{i.value="",i.oninput(),i.focus()},m()}function Oa(e,t,s,a){const n=t.trim().toLowerCase(),r=[...e.querySelectorAll("tbody tr[data-search]")],i=n&&a?a(n):null;let c=null;r.forEach(g=>{g.hidden=n?i?!i.has(g.dataset.name):!g.dataset.search.includes(n):!1,g.classList.remove("last-visible"),g.hidden||(c=g)}),c&&c.classList.add("last-visible");const b=e.querySelector(".adm-nomatch");b&&(b.hidden=!!c||!r.length);const m=e.querySelector(".adm-count");m&&(m.textContent=s(r.filter(g=>!g.hidden).length,r.length))}let pe="";const Ht={Domestic:"dom",Foreign:"for",Mixed:"mix"},ja=e=>String(e||"").split(/\s+/).filter(Boolean).slice(0,2).map(t=>t[0]).join("").toUpperCase()||"?";function Vt(e){let t=e.logoUrl||"";if(!t&&e.website){const s=String(e.website).replace(/^https?:\/\//,"").split("/")[0];s&&(t=`https://www.google.com/s2/favicons?domain=${encodeURIComponent(s)}&sz=64`)}return`<span class="vc-logo">${o(ja(e.displayName||e.name))}${t?`<img src="${o(t)}" alt="" loading="lazy" onerror="this.remove()">`:""}</span>`}function Ua(e){const t=[...e.bankName?[{t:e.bankName,cls:"bank"}]:[],...(e.departments||[]).map(n=>({t:n,cls:""}))],s=t.slice(0,3),a=t.length-s.length;return s.map(n=>`<span class="vc-chip ${n.cls}">${o(n.t)}</span>`).join("")+(a>0?`<span class="vc-chip more">+${a} more</span>`:"")}function Ha(e,t){const s=at(e.prs,t.name),a=Ft(t,e.prs),n=s.spendTotals.length?Z(...s.spendTotals[0])+(s.spendTotals.length>1?" +":""):"—";return`
    <a class="vcard" href="#/vendors/${encodeURIComponent(t.name)}" data-name="${o(t.name)}">
      ...
      <div class="vc-chips">${Ua(t)}</div>
    </a>`}const Va=e=>[...e||[]].sort((t,s)=>(t.displayName||t.name).localeCompare(s.displayName||s.name));function gt(e,t){const s=Va(e.vendors),a=t.trim()?Ut(s,t):s;return a.length?a.map(n=>Ha(e,n)).join(""):s.length?`<div class="card" style="color:var(--mut)">No vendors match “${o(t)}”.</div>`:'<div class="card" style="color:var(--mut)">No vendors yet — an admin can add them in Admin → Vendors.</div>'}function Ka(e,t,s){if(s)return za(e,t,decodeURIComponent(s));e.innerHTML=`
    <div class="dash">
      <div class="adm-head">
        <div>
          <h1>Vendors</h1>
      ...
      <div class="vsearch">${xe(pe,"Search vendors — try “sensor”, “fab”, “ahmedabad”…","vendorSearch")}</div>
      <div class="vgrid" id="vgrid">${gt(t,pe)}</div>
    </div>`;const a=e.querySelector("#vgrid"),n=e.querySelector("#vendorSearch"),r=e.querySelector(".admSearchClear"),i=()=>{pe=n.value,r.hidden=!pe,a.innerHTML=gt(t,pe)};n.oninput=i,n.onkeydown=c=>{c.key==="Escape"&&n.value&&(n.value="",i())},r.onclick=()=>{n.value="",i(),n.focus()}}function za(e,t,s){const a=(t.vendors||[]).find(m=>m.name.toLowerCase()===s.toLowerCase());if(!a){e.innerHTML=`<div class="dash"><div class="card">Vendor not found: <b>${o(s)}</b> — <a href="#/vendors">back to vendors</a></div></div>`;return}const n=at(t.prs,a.name),r=Ft(a,t.prs),i=t.me&&t.me.role==="admin",c=tt(t.prs,a.name).sort((m,g)=>(g.createdAt||"").localeCompare(m.createdAt||"")),b=[["Contact person",a.contactPerson],["Phone",a.phone],["Email",a.email],["Website",a.website],["Address",a.address],["Payment terms",a.paymentTerms],["Bank",a.bankName]].filter(([,m])=>m);e.innerHTML=`
    <div class="dash">
      <div class="adm-head">
    ...
    </div>`,e.querySelectorAll("tr.rowlink").forEach(m=>m.onclick=()=>location.hash="#/pr/"+m.dataset.id)}const Ga=["Submitted","Approved","Ordered","In Transit","Received","On Hold","Rejected","Cancelled"],_a={Submitted:"var(--blue)",Approved:"var(--brand)",Ordered:"var(--amber)","In Transit":"var(--amber)",Received:"var(--brand)","On Hold":"var(--mut)",Rejected:"var(--red)",Cancelled:"var(--red)"},Za={"0–7 days":"var(--brand)","8–14 days":"var(--brand)","15–30 days":"var(--amber)","30+ days":"var(--red)"},$e={currency:""};function Kt(e,t){const s=t.me||{role:"",department:""},a=s.role==="approver",n=a?Et(t.prs,s.department):t.prs||[],r=xt(n);r.includes($e.currency)||($e.currency=r[0]||"");const i=$e.currency,c=$=>i?Z(i,$):String($),b=i?Ke(n,"spend",i):[],m=Ke(n,"count"),g=i?ha(n,i,6).map($=>({label:$.vendor,value:$.total})):[],R=!a&&i?va(n,i).map($=>({label:$.department,value:$.total})):[],P=ya(n),O=Ga.filter($=>P[$]).map($=>({label:$,value:P[$]})),T=fa(n),L=ga(n),D=L.map($=>({label:$.label,value:$.count})),p=L.reduce(($,B)=>$+B.count,0),w=b.reduce(($,B)=>$+B.value,0);e.innerHTML=`
  ...
  </div>`}function wt(e){return[...e.querySelectorAll(".itemrow:not(.ithead)")].map(t=>{const s=a=>t.querySelector(`[name="${a}"]`).value.trim();return{description:s("i_description"),partNo:s("i_partNo"),materialType:s("i_materialType"),qty:s("i_qty"),unit:s("i_unit"),unitPrice:s("i_unitPrice"),purchaseLink:s("i_purchaseLink"),datasheetDoc:s("i_datasheetDoc"),lineTotal:s("i_lineTotal")}}).filter(t=>t.description)}function Xa(e,t,s){const a=s?t.prs.find(y=>y.id===s):null,n=a||{},r=a?n.items||[]:[{}],i=t.me||{role:""},c=["approver","admin","finance"].includes(i.role),b=a?n.department||"":i.department||"",m=(t.projects||[]).filter(y=>y.department.toLowerCase()===b.toLowerCase()).map(y=>y.project),g=(t.vendors||[]).filter(y=>(y.departments||[]).some(f=>f.toLowerCase()===b.toLowerCase())),R=y=>{const f=g.find(h=>h.name.toLowerCase()===String(y||"").toLowerCase());return f?f.displayName||f.name:String(y||"")},P=(t.materialTypes||[]).filter(y=>y.department.toLowerCase()===b.toLowerCase()).map(y=>y.materialType),O=b.toLowerCase()==="production";e.innerHTML=`
    <div class="dash form-page">
      ...
      <form id="prForm">
          ...
          <div class="pd-body pd-form">
            <div class="pd-grid">
              ...
              <div class="pd-field">${oe("Currency","currency")}
                <input aria-label="Currency" id="curSearch" class="combo" autocomplete="off" spellcheck="false" value="${o($t(n.currency||"INR"))}">
                <input type="hidden" name="currency" value="${o(n.currency||"INR")}">
                <div class="curList" id="curList" hidden></div>
              </div>
              <label>${oe("Priority","priority",!0)} <select name="priority">${ie(Ye(t,"priorities"),n.priority||"Medium")}</select></label>
              <label>${oe("Expected delivery","expected")} <input name="expectedDate" type="date" value="${o((n.expectedDate||"").slice(0,10))}"></label>
              ${c?`
              <label>${oe("Payment status*","payment")} <select name="paymentStatus" required>${ie(Qa,n.paymentStatus||"Unpaid")}</select></label>`:""}
              ${a&&i.role==="admin"?`
        ...
        <div class="card">
          ...
          <div class="pd-body pd-form">
            <div id="itemRows">${r.map((y,f)=>St(t,y,f,P,O)).join("")}</div>
  ...
  <div class="pd-person">
    ...
    <div class="dash detail-page">
      ...
      <div class="adm-head request-heading">
        <div><div class="request-title"><h1 style="margin:0">${o(a.id)}</h1>${Ne(a.status)}</div>
      ...
      <div class="card">
        ...
        <div class="pd-people">
          ${Ct("Requested by",kt(a.requestedByName,a.requesterEmail,a.approverEmail,a.approvedByName),a.requesterEmail,"Created on "+X(a.createdAt))}
          ${a.approverEmail||a.approvedByName?Ct("Approved by",kt(a.approvedByName,a.approverEmail,a.requesterEmail,a.requestedByName),a.approverEmail,a.approvedAt?"on "+X(a.approvedAt):""):""}
        </div>
        </div>
      </div>
      ...
      <div class="card">
        ...
        <div class="pd-body">
        <div class="pd-grid">
          ${G("Expected",X(a.expectedDate))}
          ${G("Received",X(a.receivedAt))}
          ${G("Tracking",a.trackingNo?`${o(a.courier||"")} <a href="${a.trackingLink?o(a.trackingLink):tn(a.courier,a.trackingNo)}" target="_blank" rel="noopener">${o(a.trackingNo)} ↗</a>`:"")}
          ${G("Notes",o(a.notes))}
        </div>
        </div>
      </div>
      ...
      <div class="card">
        ...
        <div class="pd-body">
        <div class="pd-grid">
          ${G("PO reference",[o(a.poNo),X(a.poDate)].filter(Boolean).join(" · "))}
          ${G("Invoice / order #",[o(a.invoiceNo),X(a.invoiceDate)].filter(Boolean).join(" · "))}
    ...
    <div class="adm-card" style="padding:24px">
      ...
      <div class="adm-chips" id="vDepts">
        ${nn(e).map(i=>`<button class="adm-chip ${(t.departments||[]).some(b=>b.toLowerCase()===i.toLowerCase())?"on":""}" data-dept="${o(i)}">${o(i)}</button>`).join("")}
      </div>
        ...
        <div class="adm-grid2">
          ...
          <label class="adm-field">Type
            <select class="adm-select" name="type">
              ${["",...an].map(i=>`<option value="${o(i)}" ${i===(t.type||"")?"selected":""}>${i?o(i):"—"}</option>`).join("")}
            </select>
          </label>
    ...
    <div class="adm">
      ...
      ${W==="users"?un(t):W==="vendors"?sn(t,ae):vn(t,At[W])}
    </div>`,e.querySelectorAll(".adm-tab").forEach(a=>a.onclick=()=>{W=a.dataset.tab,ae=!1,ln(),le(e,t)}),e.querySelector("#addToggle").onclick=()=>{if(ae=!ae,le(e,t),ae){const a=e.querySelector(".adm-addrow input, .adm-addrow select");a&&a.focus()}},W==="users"?pn(e,t):W==="vendors"?rn(e,t,()=>{ae=!1,le(e,t)}):hn(e,t,At[W])}function un(e){const t=a=>(he.includes(a.role)?he:[a.role,...he]).map(n=>`<option value="${o(n)}" ${n===a.role?"selected":""} ${n?"":"disabled"}>${n?o(je(n)):"— assign role —"}</option>`).join(""),s=a=>["",...a&&!Re(e).includes(a)?[a,...Re(e)]:Re(e)].map(n=>`<option value="${o(n)}" ${n===(a||"")?"selected":""}>${n?o(n):"— no department —"}</option>`).join("");return`
    ...
    <div class="adm-card">
      ...
      <div style="overflow-x:auto">
        <table class="adm-tbl">
          ...
          <tbody>
          ${[...ce].sort((a,n)=>(a.role?1:0)-(n.role?1:0)).map(a=>{const n=a.name||Me(a.email);return`<tr data-search="${nt(n,a.email)}">
            <td>
              <div class="adm-user">
                <div class="adm-avatar" style="background:${cn(a.email)}">${o(et(a.email))}${a.picture?`<img src="${o(a.picture)}" alt="" referrerpolicy="no-referrer" loading="lazy" onerror="this.remove()">`:""}</div>
                <div>
    ...
    </div>`}function pn(e,t){ot(e,{get:()=>Je,set:n=>{Je=n},count:(n,r)=>`Showing ${n} of ${r} active members`});const s=async(n,r,i)=>{try{const c=await H("userSet",{email:n,...r});ce=c.users,ae=!1,await M.applyResult(c),q(i),e.isConnected&&le(e,t)}catch(c){q(c.message,!0)}};e.querySelectorAll(".roleSel").forEach(n=>n.onchange=()=>s(n.dataset.email,{role:n.value},`${n.dataset.email} → ${n.value}`)),e.querySelectorAll(".deptSel").forEach(n=>n.onchange=()=>s(n.dataset.email,{department:n.value},`${n.dataset.email} → ${n.value||"no department"}`)),e.querySelectorAll(".rmBtn").forEach(n=>n.onclick=()=>{confirm(`Are you sure you want to remove ${n.dataset.email}? This action is permanent.`)&&s(n.dataset.email,{role:""},`${n.dataset.email} removed`)});const a=e.querySelector("#addBtn");a&&(a.onclick=()=>{const n=e.querySelector("#newEmail").value.trim(),r=e.querySelector("#newRole").value,i=e.querySelector("#newDept").value;s(n,{role:r,department:i},`${n} → ${r}`)})}function Re(e){const t=e.lists&&e.lists.departments||[],s=(fe||[]).map(a=>a.department);return[...new Set([...t,...s])]}function vn(e,t){const s=[...t.get()].sort((a,n)=>a.department.localeCompare(n.department)||a[t.key].localeCompare(n[t.key]));return`
    <div class="adm-card">
      ${xe(t.q,`Search ${t.plural} by name or department…`)}
      ${ae?`
      <div class="adm-addrow">
        <select id="mpDept" class="adm-select" style="width:auto">
          ${Re(e).map(a=>`<option value="${o(a)}">${o(a)}</option>`).join("")||'<option value="">— no departments —</option>'}
        </select>
    ...
    </div>`}const _t=(e,t,s)=>e===t?`Showing ${t} ${s.label.toLowerCase()}${t===1?"":"s"}`:`Showing ${e} of ${t} ${s.label.toLowerCase()}s`;function hn(e,t,s){ot(e,{get:()=>s.q,set:r=>{s.q=r},count:(r,i)=>_t(r,i,s)});const a=async(r,i,c)=>{try{const b=await H(r,i);s.set(b[s.respKey]),ae=!1,await M.applyResult(b),q(c),e.isConnected&&le(e,t)}catch(b){q(b.message,!0)}},n=e.querySelector("#mpAdd");n&&(n.onclick=()=>{const r=e.querySelector("#mpDept").value,i=e.querySelector("#mpName").value.trim();a(s.addRoute,{department:r,[s.key]:i},`${r} / ${i} added`)}),e.querySelectorAll(".mpRm").forEach(r=>r.onclick=()=>{const{dept:i,val:c}=r.dataset;confirm(`Remove "${c}" from ${i}?`)&&a(s.removeRoute,{department:i,[s.key]:c},`${c} removed`)})}const qe={requester:0,approver:1,finance:1,admin:2};function yn(e,t){if(!t||!e||!e.minRole)return!0;const s=qe[t.role];return s!=null&&s>=qe[e.minRole]}const Zt=document.getElementById("app"),Ue={"":{fn:Bt,nav:"Dashboard",icon:"grid"},vendors:{fn:Ka,nav:"Vendors",icon:"vendors",minRole:"admin"},insights:{fn:Kt,nav:"Insights",icon:"chart",minRole:"approver"},new:{fn:Xa,minRole:"requester"},pr:{fn:We},admin:{fn:le,nav:"Admin",icon:"settings",minRole:"admin"}};let re,Pt=null;function Yt(){const e=location.hash.replace(/^#\/?/,"").split("/");return{name:e[0]||"",param:e[1]||null}}function fn(){re==null||re.abort(),Zt.innerHTML=`<div class="auth-gate">
  ...
  </div>`,sa(document.getElementById("gsignin"))}function Wt(e){const t=document.getElementById("btnRefresh");t&&(t.disabled=e.loading,t.innerHTML=v("refresh",e.loading?"spin":""),t.setAttribute("aria-label",e.loading?"Refreshing data":"Refresh data"));const s=document.getElementById("syncState");s&&(s.classList.toggle("sync-error",!!e.err),s.textContent=e.loading?"Syncing…":e.err?"Sync failed":e.lastSync?"Up to date":"Connecting…",s.title=e.err||(e.lastSync?"Last full refresh: "+new Date(e.lastSync).toLocaleTimeString():""))}function Qt(){var E,j,_;const e=M.get(),{name:t,param:s}=Yt(),a=Ue[t]||Ue[""],n=((E=e.me)==null?void 0:E.role)||"";if(e.me&&!yn(a,e.me)){location.hash="#/";return}re==null||re.abort(),re=new AbortController;const r=re.signal,i=Object.entries(Ue).filter(([,d])=>d.nav&&(!d.minRole||qe[n]>=qe[d.minRole])).map(([d,S])=>`<a href="#/${d}" ${t===d?'aria-current="page"':""} class="${t===d?"active":""}">${v(S.icon)}<span>${S.nav}</span>${t===d?'<span class="nav-dot"></span>':""}</a>`).join(""),c=e.notifications||[],b=c.filter(d=>!d.readAt).length,m=ta()||{},g=m.email||((j=e.me)==null?void 0:j.email)||"",R=m.name||Me(g),P=m.picture?`<img class="avatar" src="${o(m.picture)}" alt="" referrerpolicy="no-referrer">`:`<span class="avatar avatar-txt">${o(et(R))}</span>`,O=a.nav||(t==="new"?s?"Edit request":"New request":"Purchase request");document.title=O+" · Oizom Procurement",Zt.innerHTML=`<div class="app-shell" id="shell">
